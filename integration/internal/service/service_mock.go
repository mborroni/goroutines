...
func (m *MockService) Run(task Task, ch chan string, wg *sync.WaitGroup) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Run", task, ch, wg)
}

// Run indicates an expected call of Run
func (mr *MockServiceMockRecorder) Run(task, ch, wg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockService)(nil).Run), task, ch, wg)
}
